 ...
 * Jun 4, 2013
 */
package pt.lsts.neptus.plugins.followntnu;
 ...
 *
 */
@PluginDescription(name = "FollowReference Interaction for NTNU", category = CATEGORY.PLANNING, icon = "pt/lsts/neptus/plugins/followref/NTNU.png")
...
/*
    ...
    public void on(PlanControlState controlState) {
        ...
        if (controlState.getPlanId().equals("follow_ntnu")
                ...
                if (!activeVehicles.contains(sysName)) {
                    popup.add("Activate Follow Reference for " + sysName).addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            startPlan.setPlanId("follow_ntnu");
